        ...
        <div className='h-screen justify-center flex'>
            <div className='text-center p-5 self-center'>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-5">
                    <div className="p-5">
                        <div className="inline-block ring-white rounded-full h-36 w-36 overflow-hidden flex justify-center bg-gradient-to-b from-indigo-500 to-violet-400">
                    ...
                    <div className="p-5">
                        <div className="inline-block ring-white rounded-full h-36 w-36 overflow-hidden flex justify-center bg-gradient-to-b from-orange-500 to-amber-400">
                    ...
                    <div className="p-5">
                        <div className="inline-block ring-white rounded-full h-36 w-36 overflow-hidden flex justify-center bg-gradient-to-b from-rose-600 to-fuchsia-500">
                    ...
                    <div className="p-5">
                        <div className="inline-block ring-white rounded-full h-36 w-36 overflow-hidden flex justify-center bg-gradient-to-b from-lime-600 to-yellow-300">
                            <img class="object-cover contrast-200 brightness-0" src={require('../asset/image/Daviadi.png')} alt="Foto Daviadi" />
                        </div>
